...
## 📊 Phase 3: 리포트 & 자동화 - ✅ 완료 (2025-11-15~2026-01-09)
...
### 완료 기준
- [x] 이번 주 리포트 확인 (완료율, 집중 시간)
- [x] 히트맵에서 생산성 높은 시간대 확인
- [x] 매일 반복 루틴 자동 생성
- [x] 생산성 패턴 인사이트 표시
...
- [x] **Phase 3**: 리포트 & 자동화 - 2025-11-15
  - **Week 6**: 리포트 대시보드 (recharts, 목표 달성률, 집중 시간 통계)
  - **Week 7**: 패턴 분석 (히트맵, 요일별 생산성, AI 인사이트)
  - **Week 8**: 루틴 자동화 (Routine 모델, 자동 작업 생성, 루틴 관리 UI)
- [x] 배포 환경 구축
