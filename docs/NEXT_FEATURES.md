...
### 2. 소프트 삭제 항목 관리 UI (휴지통) ✅ **완료 (2026-01-05)**
**현재 상태**: ~~소프트 삭제 로직 구현 완료, UI 없음~~ → **구현 완료**

**구현 완료**:
- [x] 설정 → "휴지통" 탭 추가
- [x] 삭제된 작업 목록 표시 (deletedAt 기준)
- [x] 복구 버튼 (deletedAt = null)
- [x] 영구 삭제 버튼 (실제 DELETE)
- [ ] 30일 후 자동 영구 삭제 (Cron Job) - 향후 추가 가능
